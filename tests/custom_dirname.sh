...
mkdir -p expected/dirname/logdir/test000001/test0/workdir

printf "+ true\n"   > expected/dirname/logdir/test000001/test0/output
printf "0\n"        > expected/dirname/logdir/test000001/test0/exitstatus
